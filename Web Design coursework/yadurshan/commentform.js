...
if ((n!="")  && (com!="") && ((a.checked == true) || (b.checked == true) || (c.checked == true) || (d.checked == true)|| (e.checked == true)|| (f.checked == true))|| (g.checked == true)|| (h.checked == true)|| (i.checked == true)|| (j.checked == true)){
		alert("Dear "+ n +" , Thank you very much for your feedback. You have rated our site as "+rating+".");
		return false;
	}
